    ...
    class ScaffoldGenerator < Base
      ...
      def create_controller
        unless options.skip_controller?
          ...
          template "views/index.js.erb", "app/views/#{plural_name}/index.js.erb" if actions? :index
          
          template "views/_form.html.haml", "app/views/#{plural_name}/_form.html.haml" if form_partial?
       
          template "views/_table.html.haml", "app/views/#{plural_name}/_table.html.haml" if table_partial?
      ...
      def render_table
        if table_partial?
          ...
          read_template("views/_table.html.haml")
        end
      end
